...
import {ACTION_NAVIGATE} from "next/dist/client/components/router-reducer/router-reducer-types"; // Ensure React is imported if not already
  ...
  return (
    <footer className="w-full h-20 flex items-center justify-center bg-white border-t border-animated">
      <a
        ...
        href="https://www.liknoss.com/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <ActivitySquare className="h-5 w-5 mr-2" />
        Learn More about Liknoss
      </a>
    </footer>
  )
}
